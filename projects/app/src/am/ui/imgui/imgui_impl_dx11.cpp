...
// Prefer including the entire imui/ repository into your project (either as a copy or as a submodule), and only build the backends you need.
// If you are new to Dear ImGui, read documentation from the docs/ folder + read the top of imgui.cpp.
// Read online: https://github.com/ocornut/imui/tree/master/docs
...
// CHANGES FOR RAGE AM
// ImGui_ImplDX11_Shutdown doesn't destroy direct x device anymore
// ImGui_ImplDX11_CreateFontsTexture pFontSampler MaxLOD set to D3D11_FLOAT32_MAX to enable mip-map rendering
...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
	...
	// See https://github.com/ocornut/imui/pull/638 for sources and details.
...
void ImGui_ImplDX11_Shutdown()
{
	...
	// We don't want gta dx device to be destroyed on reload...
